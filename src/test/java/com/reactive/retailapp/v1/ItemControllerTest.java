package com.reactive.retailapp.v1;
...
public class ItemControllerTest {
    ...
    public void getAllItemsApproach3(){
        Flux<Item> itemFlux = webTestClient.get().uri(ItemConstants.ITEM_END_POINT_V1)
               ...
               .returnResult(Item.class)
                .getResponseBody();
        StepVerifier.create(itemFlux.log("calue from network : "))
                .expectNextCount(5)
                .verifyComplete();
    }
    ...
    public void getOneItem(){
        webTestClient.get().uri(ItemConstants.ITEM_END_POINT_V1.concat("/{id}"), "ABE")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void deleteItem(){
                webTestClient.delete().uri(ItemConstants.ITEM_END_POINT_V1.concat("/{id}"), "ABE")
                .exchange()
                .expectStatus().isOk()
    ...
    public void updateItem(){
        ...
        webTestClient.put().uri(ItemConstants.ITEM_END_POINT_V1.concat("/{id}"), "ABE")
               .contentType(MediaType.APPLICATION_JSON)
    ...
    public void updateItemInvalidId(){
        ...
        webTestClient.put().uri(ItemConstants.ITEM_END_POINT_V1.concat("/{id}"), "ABF")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .body(Mono.just(item), Item.class)
                .exchange()
